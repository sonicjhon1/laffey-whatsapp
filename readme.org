...
Without embedded B64 theme (Theme may load slower depending on your internet connection)
...
With embedded B64 theme (Theme will load faster because theme's images are saved locally)
